...
public class SettingsScreen extends ScreenAdapter {
    ...
    public SettingsScreen(MyGdxGame myGdxGame) {
        ...
        titleTextView = new TextView(myGdxGame.largeWhiteFont, GameSettings.SCREEN_WIDTH / 2 - 100, 956, "Settings");
        blackoutImageView = new ImageView(0, 365, GameResources.BLACKOUT_FULL_IMG_PATH);
        clearSettingView = new TextView(myGdxGame.commonWhiteFont, 930, 599, "Clear Records");
        ...
        returnButton = new ButtonView(
                GameSettings.SCREEN_WIDTH / 2 - 80, 447,
                160, 70,
